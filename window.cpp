...
void qWindow::paintEvent(QPaintEvent *)
{
    ...
    pen.setColor(h.ShouldTrigger ? greenTrue : redFalse);
    painter.setPen(pen);
    painter.drawText(settings::window::wind_width * .2, 105, (h.ShouldTriggerToggleKey + " Trigger: " + helper::AtomicBoolToString(&h.ShouldTrigger)).c_str());
